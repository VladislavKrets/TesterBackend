...
class Setup(APIView):
    def get(self, request):
        curr_question = models.Question.objects.filter(topic__id=10, text__icontains='Преобразуйте десятичное число 231 в его двоичный эквивалент. Выберите правильный ответ из списка ниже.')
        print(curr_question)
